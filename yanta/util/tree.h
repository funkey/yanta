#ifndef YANTA_TREE_H__
#define YANTA_TREE_H__
 ...
 * called.
 */
#define YANTA_TREE_VISITABLE() template <typename VisitorType> void accept(VisitorType& visitor) { visitor.enter(*this); visitor.visit(*this); visitor.traverse(*this, visitor); visitor.leave(*this); }
